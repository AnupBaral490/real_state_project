...
SECRET_KEY = 'django-insecure-&384duj=8^23lzq^qr^o7npm3o9zo^@n7-$4yz=f^@w#y*jm%$'
...
JAZZMIN_SETTINGS = {
    ...
    "site_brand": "Real Est",
    "site_logo": None,
    "welcome_sign": "Welcome to Real Estate Management System",
    "copyright": "2024 Real Estate Management",
    "search_model": ["users.User", "properties.Property", "agents.Agent"],
    "user_avatar": None,
    "show_sidebar": True,
